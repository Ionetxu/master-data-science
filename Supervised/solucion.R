...
my_data<-as.data.frame(fread("./data_in/boston_housing_dataset.txt"))
...
my_pred<-as.data.frame(exp(predict.lm(model,newdata=my_data,interval="confidence",level = 0.99)))
